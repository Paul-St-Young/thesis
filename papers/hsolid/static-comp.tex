...
%\end{subfigure}
%\begin{subfigure}{0.48\textwidth}
%\includegraphics[scale=0.48]{figures/c2c/006b_c2c_step5}
%\caption{Drummond SJB.\label{fig:static-c2c-yang-drummond-last}}
%\end{subfigure}
...
%\end{subfigure}
%\begin{subfigure}{0.48\textwidth}
%\includegraphics[scale=0.48]{figures/cmca4/006b_cmca4_step2}
%\caption{Add back flow to Drummond.\label{fig:static-cmca4-yang-drummond-azadi-sjb}}
%\end{subfigure}
...
\subsection{Enthalpy v.s. Pressure}
