...
Using an integral identity, T. Gaskell found a general relation between $S(\bs{k})$ and $u_{\bs{k}}$ shown in eq.~(4) in Ref.~\cite{Gaskell1961}, which in current notations states
\begin{align}
