...
\end{array}\right),
\end{align}
giving the 1-electron hamiltonian eq.~(\ref{eq:hf-hcore})
\begin{align}
\hcore = \left(\begin{array}{cc}
-1.120409 & -0.95837996 \\
-0.95837996 & -1.120409
\end{array}\right).
\end{align}
...
\end{array}\right).\label{eq:h2-fock-r14}
\end{align}
The total electronic energy is $-1.831$ ha, while the total energy is $-1.11671432$ ha after adding ion-ion repulsion. Interested reader should reproduce the Fock matrix for STO-3G H$_2$ at 1.4 bohr separation, i.e. eq.~(\ref{eq:h2-fock-r14}), to consolidate a practical understanding of RHF.
