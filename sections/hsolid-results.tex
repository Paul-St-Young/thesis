...
In contrast, the width of the gaussians in the proton orbital $C_p$ are optimized using \emph{maximum overlap}~\cite{Reatto1982}.
...
The Cmca-4 and C2/c-24 structures become metallic at roughly $r_s=1.22$ and $rs=1.17$, respectively. These densities correspond to $550$ GPa and $800$ GPa, which are much too high compared to experiment~\cite{Loubeyre2020} and calculation~\cite{Gorelov2019}.
