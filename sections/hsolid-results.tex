...
The fitted EOS reproduces the QMC data to well within $1$ meV/p while interpolating between $212$ and $413$ GPa, and incurs an error of $1.5$ meV/p when extrapolated by $50$ GPa to $163$ GPa.
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.6]{h117ds_drum-eos}
