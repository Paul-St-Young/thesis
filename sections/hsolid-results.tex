...
The DMC optimizations have been carried out at evenly spaced $r_s$ values: $1.31$, $1.29$, $1.27$, $\dots$, $1.17$.
...
Thus, when calculating energy and enthalpy differences, interpolation must occur further from data for the atomic structure than the molecular structures.
...
In contrast, the width of the gaussians in the proton orbital $C_p$ are optimized using \emph{maximum overlap}.
...
\centering
\includegraphics[width=\textwidth]{h117ds_rm121_var-vs-p}
\end{minipage}
...
The inverse dielectric function is bounded from above by $\epsilon^{-1}(k) \le 1-\Gamma_k^2$, where
\begin{align}
...
The Cmca-4 and C2/c-24 structures become metallic at roughly $r_s=1.22$ and $rs=1.17$, respectively. These densities correspond to $550$ GPa and $800$ GPa, which are much too high compared to experiment.
...
\begin{minipage}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{h117gd_c2c-s2-psk}\\
(a) C2/c-24
\end{minipage}
\begin{minipage}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{h117gd_cmca12-s2-psk}\\
(b) Cmca-12
\end{minipage}
\begin{minipage}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{h117gd_cmca4-s2-psk}\\
(c) Cmca-4
\end{minipage}
\begin{minipage}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{h117gd_i41amd-s2-psk}\\
(d) I4$_1$/amd
\end{minipage}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.6]{h117gd_ppsk-peaks-vs-pgpa}
\end{figure}
