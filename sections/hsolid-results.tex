...
\end{minipage}
\caption{Proton-proton pair correlation functions around $r_s=1.25$ ($480$ GPa). The solid lines in (b) are quadratic fits to the smooth part of $S(k)$. The Bragg peaks of the pp $S(k)$ and $S(0)$ are shown in Fig.~\ref{fig:sg-vs-pgpa} as functions of pressure.}
...
\end{minipage}
\caption{Bragg peak and long wavelength limit of the proton-proton static structure factor as functions of QMC EOS pressure.}
\label{fig:sg-vs-pgpa}
\end{figure}
