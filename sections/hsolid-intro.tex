...
In 2007, the advent of random structure searching produced new candidate crystal structures that have lower enthalpy than all previously proposals~\cite{Pickard2007}. The insulating layered structure having C2/c symmetries became the main candidates for phase III.
