...
Substitute $\Psi_T^{-1}f$ in place of $\Psi_0$ into the imaginary-time Schr\"odinger equation
...
After this ``important-sampling transformation'', the Green function for obtaining the mixed distribution $f$ has three contributing processes: diffusion, weighting, and drift. In practice, the mixed distribution is approximated by an ensemble of walkers
\begin{align}
