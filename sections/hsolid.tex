...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\linewidth]{mcmahon-phases.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\linewidth]{phases123.png}
...
\centering
\includegraphics[width=\columnwidth]{p-h2-bsp-rotons.png}
(a) rotons
\end{minipage}
\begin{minipage}{0.58\columnwidth}
\centering
\includegraphics[width=\columnwidth]{p-h2-bsp-vibron.png}
(b) vibron
\end{minipage}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\linewidth]{hsolid-phases.png}
...
\begin{figure}[h]
	...
	\begin{minipage}{0.49\textwidth}
		\centering
		\includegraphics[width=0.6\linewidth]{supercell-square.png}\\
		(a) square $a=2$ \AA
	\end{minipage}
	\begin{minipage}{0.49\textwidth}
		\centering
		\includegraphics[width=\linewidth]{supercell-rhombus.png}\\
